...
const ICONS = {
  ...
  help: (
    <path strokeLinecap="round" strokeLinejoin="round" d="M9.879 7.519c1.171-1.025 3.071-1.025 4.242 0 1.172 1.025 1.172 2.687 0 3.712-.203.179-.43.326-.67.442-.745.361-1.45.999-1.451 1.827v.75M12 18h.01" />
  ),
  close: (
  ...
  film: (
    <path strokeLinecap="round" strokeLinejoin="round" d="M3.375 19.5h17.25m-17.25 0a1.125 1.125 0 0 1-1.125-1.125M3.375 19.5h1.5C5.496 19.5 6 18.996 6 18.375m-3.75.125V4.875C2.25 3.839 3.089 3 4.125 3h15.75c1.036 0 1.875.84 1.875 1.875v13.5M3.375 19.5h1.5C5.496 19.5 6 18.996 6 18.375m0 0v-2.25m12.375 2.25h-1.5c-.621 0-1.125-.504-1.125-1.125m0 0v-2.25m0 2.25H9m-3-4.5h12M9 9h6m-6 3h6" />
  ),
  volume: (
  ...
  trophy: (
    <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 18.75h-9m9 0a3 3 0 0 1 3-3h.75a.75.75 0 0 0 .75-.75v-.75a3 3 0 0 0-3-3h-.75V5.25a1.5 1.5 0 0 0-1.5-1.5h-9a1.5 1.5 0 0 0-1.5 1.5v6H4.5a3 3 0 0 0-3 3v.75c0 .414.336.75.75.75h.75a3 3 0 0 1 3 3m9 0v1.5a.75.75 0 0 1-.75.75h-7.5a.75.75 0 0 1-.75-.75v-1.5m9 0h-9" />
  ),
  cake: (
  ...
  medal: (
    <>
      ...
      <path strokeLinecap="round" strokeLinejoin="round" d="M9.75 2.25 8.25 9m6-6.75L15.75 9M12 2.25V9" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M10 14l1.5 1.5 3-3" />
    </>
  ),
  ...
  thumbsUp: (
    <path strokeLinecap="round" strokeLinejoin="round" d="M6.633 10.25c.806 0 1.533-.446 2.031-1.08a9.041 9.041 0 0 1 2.861-2.4c.723-.384 1.35-.956 1.653-1.715a4.498 4.498 0 0 0 .322-1.672V3a.75.75 0 0 1 .75-.75 2.25 2.25 0 0 1 2.25 2.25c0 1.152-.26 2.243-.723 3.218-.266.558.107 1.282.725 1.282m0 0h3.126c1.026 0 1.945.694 2.054 1.715.045.422.068.85.068 1.285a11.95 11.95 0 0 1-2.649 7.521c-.388.482-.987.729-1.605.729H13.48c-.483 0-.964-.078-1.423-.23l-3.114-1.04a4.501 4.501 0 0 0-1.423-.23H5.904m7.723-9.132c.065.21.1.433.1.664 0 .414-.336.75-.75.75H4.51c-.88 0-1.704-.507-1.938-1.354A9.009 9.009 0 0 1 2.25 12c0-.83.112-1.633.322-2.396C2.806 8.756 3.63 8.25 4.51 8.25H6.633Z" />
  ),
  textFont: (
    <path strokeLinecap="round" strokeLinejoin="round" d="m10.5 21 5.25-11.25L21 21m-9-3h7.5M3 5.621a48.474 48.474 0 0 1 6-.371m0 0c1.12 0 2.233.038 3.334.114M9 5.25V3m3.334 2.364V3m3.416 2.778a48.5 48.5 0 0 0-3.416-.778M3 11.25c9.75 0 11.25-4.125 11.25-4.125" />
  ),
  handshake: (
    <path strokeLinecap="round" strokeLinejoin="round" d="M10.05 4.575a1.575 1.575 0 1 0-3.15 0v3m3.15-3v-1.5a1.575 1.575 0 0 1 3.15 0v1.5m-3.15 0 .075 5.925m3.075-7.425a1.575 1.575 0 0 1 3.15 0v1.5m-3.15-1.5v4.5m3.15-3a1.575 1.575 0 0 1 3.15 0V12a7.35 7.35 0 0 1-7.35 7.35h-2.1a7.35 7.35 0 0 1-7.35-7.35V7.425a1.575 1.575 0 0 1 3.15 0v3" />
  ),

  // ── Emoji Reactions (simple face/gesture SVGs) ─────────────
  emojiLaugh: (
    <>
      <circle cx="12" cy="12" r="9.5" />
      <path d="M8 14.5c1.2 1.5 2.5 2.2 4 2.2s2.8-.7 4-2.2" strokeLinecap="round" />
      <path d="M8.5 8.5c.4.5.9.8 1.5.8s1.1-.3 1.5-.8M12.5 8.5c.4.5.9.8 1.5.8s1.1-.3 1.5-.8" strokeLinecap="round" />
    </>
  ),
  emojiWow: (
    <>
      <circle cx="12" cy="12" r="9.5" />
      <circle cx="9" cy="9.5" r=".75" fill="currentColor" stroke="none" />
      <circle cx="15" cy="9.5" r=".75" fill="currentColor" stroke="none" />
      <ellipse cx="12" cy="15.5" rx="1.75" ry="2.25" />
    </>
  ),
  emojiClap: (
    <path strokeLinecap="round" strokeLinejoin="round" d="M10.05 4.575a1.575 1.575 0 1 0-3.15 0v3m3.15-3v-1.5a1.575 1.575 0 0 1 3.15 0v1.5m-3.15 0 .075 5.925m3.075-7.425a1.575 1.575 0 0 1 3.15 0v1.5m-3.15-1.5v4.5m3.15-3a1.575 1.575 0 0 1 3.15 0V12a7.35 7.35 0 0 1-7.35 7.35h-2.1a7.35 7.35 0 0 1-7.35-7.35V7.425a1.575 1.575 0 0 1 3.15 0v3" />
  ...
  emojiSad: (
    <>
      <circle cx="12" cy="12" r="9.5" />
      <path d="M8 16c1.2-1.5 2.5-2 4-2s2.8.5 4 2" strokeLinecap="round" />
      <circle cx="9" cy="9.5" r=".75" fill="currentColor" stroke="none" />
      <circle cx="15" cy="9.5" r=".75" fill="currentColor" stroke="none" />
    </>
  ),
  ...
  helpCircle: (
    <>
      <circle cx="12" cy="12" r="9.5" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M9.879 9.879a3 3 0 0 1 4.243 0M12 14.25v.75m0 2.25h.008v.008H12V17.25Z" />
    </>
  ),
}
