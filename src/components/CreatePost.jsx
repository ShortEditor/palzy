...
export default function CreatePost({ onPostCreated }) {
  ...
  const fileInputRef = useRef(null) // native file input — works on ALL devices
  ...
  // ── Drag-and-drop support (desktop only, won't break mobile) ─
  ...
  return (
    ...
    >
      {/* Hidden native file input — works on iOS, Android, desktop */}
      <input
        ref={fileInputRef}
        type="file"
        accept="image/*"
      ...
      <div className="create-post-input-wrap">
        ...
        {/* Action row — ALWAYS visible so image button is accessible on mobile */}
        <div className="create-post-actions">
          <div className="create-post-tools">
            {/* Image picker button — triggers native file picker (works on mobile) */}
            <button
              id="btn-add-image"
              type="button"
